  ...
  <body>
    ...
    <div class="container">
      <form class="form-horizontal pt-5" action="<c:url value='add-course'/>" method="post">
        ...
        <div class="form-group">
          <label class="control-label col-sm-2" for="email">Лекционных часов:</label>
          <div class="col-sm-10">
        ...
        <div class="form-group">
          <label class="control-label col-sm-2" for="pwd">Практических часов:</label>
          <div class="col-sm-10">
        ...
        <div class="form-group">
          <label class="control-label col-sm-2" for="pwd">Ссылка на пройденный курс:</label>
          <div class="col-sm-10">
            <input type="url" class="form-control" id="course-url" name="course-url" placeholder="Вставьте ссылку на пройденный курс">
          </div>
        </div>
        <div class="form-group">
          <label class="control-label col-sm-2" for="pwd">Ссылка на сертификат:</label>
          <div class="col-sm-10">
